...
class Students:
    college_name = "SSPI" # class Attributes of class its create one time in class, but name & marks create 2 time even as much we create the obj and as much auto create the name and marks
